...
export const complianceItems: ComplianceItem[] = [
  ...
  {
    id: 'dsa', name: 'DSA 數位服務法', fullName: 'Digital Services Act (EU) 2022/2065',
    description: '歐盟數位服務法，Amazon 作為超大型線上平台（VLOP）已全面適用。所有第三方賣家必須完成 KYB（Know Your Business）身分驗證，未通過驗證將被暫停銷售權限。',
    countries: ['DE', 'FR', 'IT', 'ES'], timeline: '2-4 週（驗證流程）', cost: '免費（但需準備文件）', difficulty: 2, mandatory: true, category: 'registration',
    warning: '🚨 Amazon 已開始強制執行 DSA 賣家驗證。未完成 KYB 驗證的賣家將被暫停銷售權限，商品將無法在歐盟站點顯示。2025年起新賣家必須在開始銷售前完成驗證。',
    documents: [
      { name: '公司營業登記證明', description: '公司註冊文件或商業登記證（需翻譯為英文或當地語言）' },
      { name: '法定代表人身分證明', description: '護照或身分證影本' },
      { name: '公司地址證明', description: '銀行對帳單、水電帳單或官方信函（3個月內）' },
      { name: '聯絡資訊', description: '電話號碼、電子郵件、實體地址（將公開顯示在商品頁面）' },
    ],
    tips: [
      'Amazon 會在 Seller Central 發送 KYB 驗證通知，務必在期限內完成',
      '驗證資訊包括：公司名稱、註冊地址、法定代表人、聯絡方式',
      '⚠️ 部分資訊（公司名稱、地址、聯絡方式）將公開顯示在商品頁面',
      '非歐盟企業同樣需要完成驗證，無法豁免',
      '建議提前準備好所有文件的英文版本，加速審核流程',
      '如果公司資訊有變更（地址、法人等），需在 14 天內更新',
      'Amazon 可能會定期要求重新驗證，保持文件更新',
    ],
    source: 'EU Regulation 2022/2065 (DSA) / Amazon Seller Central DSA Compliance',
  },
];
